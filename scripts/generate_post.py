...
def build_prompt(city, angle):
    return (
        ...
        + '  "excerpt_en": "...",\n'
        + "  \"body_zh_html\": \"<p>...</p><h2>...</h2><p>...</p>...(內含 [IMAGE_1] [IMAGE_2] [IMAGE_3] [IMAGE_4] [IMAGE_5] [IMAGE_6] 佔位符,以及至少兩個 <blockquote class='pull-quote'>金句</blockquote>,注意 HTML 屬性一律用單引號)\",\n"
        + '  "body_en_html": "<p>...</p>...(same structure but NO [IMAGE_x] placeholders at all, single quotes for HTML attributes)",\n'
        + '  "image_queries": {"cover_image_query": "...", "image_1": "...", "image_2": "...", "image_3": "...", "image_4": "...", "image_5": "...", "image_6": "..."},\n'
        + '  "tags": ["...", "..."],\n'
        + '  "reading_time": 12\n'
        + "}"
    )
...
def main():
    ...
    body_zh = insert_images(article["body_zh_html"], [img1, img2, img3, img4, img5, img6])
    body_en = article["body_en_html"]
